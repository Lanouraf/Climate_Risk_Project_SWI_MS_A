...
**SWI uniforme mensuel (cat nat)**  
https://www.data.gouv.fr/datasets/donnees-mensuelles-dindice-dhumidite-des-sols-pour-le-dispositif-catastrophes-naturelles/

**BRGM (quantité d'argile dans les sols)**  
https://www.data.gouv.fr/datasets/tiles-rga-brgm-2020/

**Découpage administratif du territoire français**  
https://geoservices.ign.fr/adminexpress


lien de données brutes
